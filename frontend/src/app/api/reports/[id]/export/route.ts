...
export async function GET(
  ...
  try {
    ...
    if (format === 'csv') {
      ...
      // Converte Buffer para ArrayBuffer que é aceito pelo NextResponse
      return new NextResponse(xlsx.buffer.slice(xlsx.byteOffset, xlsx.byteOffset + xlsx.byteLength), {
        headers: {
